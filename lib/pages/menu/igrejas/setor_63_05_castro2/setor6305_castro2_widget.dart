...
class _Setor6305Castro2WidgetState extends State<Setor6305Castro2Widget> {
  late Setor6305Castro2Model _model;
                        ...
                        children: [
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        address:
                                            'Rua Conto de Areia, 295 - Conj. Hab. Castro A, São Paulo - SP, 08474-220',
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        location: FFAppState().localCastro2,
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                16.0, 8.0, 0.0, 0.0),
                            child: Text(
                              'Rua Conto de Areia, 41 - Conj. Hab. Castro A',
                              style: FlutterFlowTheme.of(context)
                                  .headlineSmall
                                  .override(
                                    fontFamily: 'Plus Jakarta Sans',
