...
import 'setor6317_jardim_vitoria_model.dart';
export 'setor6317_jardim_vitoria_model.dart';

class Setor6317JardimVitoriaWidget extends StatefulWidget {
  const Setor6317JardimVitoriaWidget({super.key});

  @override
  State<Setor6317JardimVitoriaWidget> createState() =>
      _Setor6317JardimVitoriaWidgetState();
}

class _Setor6317JardimVitoriaWidgetState
    extends State<Setor6317JardimVitoriaWidget> {
  late Setor6317JardimVitoriaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Setor6317JardimVitoriaModel());
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        address:
                                            'R. Atalaia, 27 - Cidade Tiradentes, São Paulo - SP, 08473-870',
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        location: FFAppState().localJVitoria,
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  16.0, 8.0, 0.0, 0.0),
                              child: Text(
                                'R. Atalaia, 27 - Cidade Tiradentes',
                                style: FlutterFlowTheme.of(context)
                                    .headlineSmall
                                    .override(
                                      fontFamily: 'Plus Jakarta Sans',
