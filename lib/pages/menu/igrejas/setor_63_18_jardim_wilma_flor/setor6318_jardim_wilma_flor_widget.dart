...
import 'setor6318_jardim_wilma_flor_model.dart';
export 'setor6318_jardim_wilma_flor_model.dart';

class Setor6318JardimWilmaFlorWidget extends StatefulWidget {
  const Setor6318JardimWilmaFlorWidget({super.key});

  @override
  State<Setor6318JardimWilmaFlorWidget> createState() =>
      _Setor6318JardimWilmaFlorWidgetState();
}

class _Setor6318JardimWilmaFlorWidgetState
    extends State<Setor6318JardimWilmaFlorWidget> {
  late Setor6318JardimWilmaFlorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Setor6318JardimWilmaFlorModel());
                        ...
                        children: [
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        address:
                                            'R. Nova Guaianazes, 231 - Guaianases, São Paulo - SP, 08473-001',
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        location: FFAppState().localJWilmaFlor,
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                16.0, 8.0, 0.0, 0.0),
                            child: Text(
                              'R. Nova Guaianazes, 231 - Guaianases, São Paulo',
                              style: FlutterFlowTheme.of(context)
                                  .headlineSmall
                                  .override(
                                    fontFamily: 'Plus Jakarta Sans',
