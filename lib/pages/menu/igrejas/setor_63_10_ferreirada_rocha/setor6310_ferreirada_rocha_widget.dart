...
class Setor6310FerreiradaRochaWidget extends StatefulWidget {
  const Setor6310FerreiradaRochaWidget({super.key});

  @override
  State<Setor6310FerreiradaRochaWidget> createState() =>
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        location:
                                            FFAppState().localFerreiraDaRocha,
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
