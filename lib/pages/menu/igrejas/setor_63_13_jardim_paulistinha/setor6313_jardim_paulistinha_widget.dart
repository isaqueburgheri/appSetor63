...
import 'setor6313_jardim_paulistinha_model.dart';
export 'setor6313_jardim_paulistinha_model.dart';

class Setor6313JardimPaulistinhaWidget extends StatefulWidget {
  const Setor6313JardimPaulistinhaWidget({super.key});

  @override
  State<Setor6313JardimPaulistinhaWidget> createState() =>
      _Setor6313JardimPaulistinhaWidgetState();
}

class _Setor6313JardimPaulistinhaWidgetState
    extends State<Setor6313JardimPaulistinhaWidget> {
  late Setor6313JardimPaulistinhaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Setor6313JardimPaulistinhaModel());
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        address:
                                            'Rua Francisco José Alves - Cidade Tiradentes, São Paulo - SP',
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        location:
                                            FFAppState().localJardimPaulistinha,
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
