...
import 'setor6324_fonte_nova_model.dart';
export 'setor6324_fonte_nova_model.dart';

class Setor6324FonteNovaWidget extends StatefulWidget {
  const Setor6324FonteNovaWidget({super.key});

  @override
  State<Setor6324FonteNovaWidget> createState() =>
      _Setor6324FonteNovaWidgetState();
}

class _Setor6324FonteNovaWidgetState extends State<Setor6324FonteNovaWidget> {
  late Setor6324FonteNovaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Setor6324FonteNovaModel());
                        ...
                        children: [
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        address:
                                            'R. Saramandaia - Conj. Hab. Juscelino Kubitscheck de Oliveira, São Paulo - SP',
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        location: FFAppState().localFonteNova,
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                16.0, 8.0, 0.0, 0.0),
                            child: Text(
                              'Rua Saramandaia, 32 -  São Paulo - SP',
                              style: FlutterFlowTheme.of(context)
                                  .headlineSmall
                                  .override(
                                    fontFamily: 'Plus Jakarta Sans',
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  16.0, 8.0, 0.0, 44.0),
                              child: Text(
                                'Conjunto Habitacional Juscelino \nKubitscheck de Oliveira',
                                style: FlutterFlowTheme.of(context)
                                    .labelLarge
                                    .override(
                                      fontFamily: 'Plus Jakarta Sans',
