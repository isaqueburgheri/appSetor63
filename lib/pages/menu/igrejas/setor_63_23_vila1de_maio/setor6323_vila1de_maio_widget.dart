...
import 'setor6323_vila1de_maio_model.dart';
export 'setor6323_vila1de_maio_model.dart';

class Setor6323Vila1deMaioWidget extends StatefulWidget {
  const Setor6323Vila1deMaioWidget({super.key});

  @override
  State<Setor6323Vila1deMaioWidget> createState() =>
      _Setor6323Vila1deMaioWidgetState();
}

class _Setor6323Vila1deMaioWidgetState
    extends State<Setor6323Vila1deMaioWidget> {
  late Setor6323Vila1deMaioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Setor6323Vila1deMaioModel());
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        address:
                                            'R. Coutinho Melo, 38 - Guaianases, São Paulo - SP, 08473-430',
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        location: FFAppState().localVila1DeMaio,
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
