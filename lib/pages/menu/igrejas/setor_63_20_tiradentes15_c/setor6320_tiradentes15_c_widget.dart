...
import 'setor6320_tiradentes15_c_model.dart';
export 'setor6320_tiradentes15_c_model.dart';

class Setor6320Tiradentes15CWidget extends StatefulWidget {
  const Setor6320Tiradentes15CWidget({super.key});

  @override
  State<Setor6320Tiradentes15CWidget> createState() =>
      _Setor6320Tiradentes15CWidgetState();
}

class _Setor6320Tiradentes15CWidgetState
    extends State<Setor6320Tiradentes15CWidget> {
  late Setor6320Tiradentes15CModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Setor6320Tiradentes15CModel());
                        ...
                        children: [
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        address:
                                            'R. Manoel Campos, 171 - Cidade Tiradentes, São Paulo - SP, 08471-230',
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                16.0, 8.0, 0.0, 0.0),
                            child: Text(
                              'R. Manoel Campos, 171 - Cidade Tiradentes',
                              style: FlutterFlowTheme.of(context)
                                  .headlineSmall
                                  .override(
                                    fontFamily: 'Plus Jakarta Sans',
