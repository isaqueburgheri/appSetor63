...
import 'setor6321_tiradentes_d_g_model.dart';
export 'setor6321_tiradentes_d_g_model.dart';

class Setor6321TiradentesDGWidget extends StatefulWidget {
  const Setor6321TiradentesDGWidget({super.key});

  @override
  State<Setor6321TiradentesDGWidget> createState() =>
      _Setor6321TiradentesDGWidgetState();
}

class _Setor6321TiradentesDGWidgetState
    extends State<Setor6321TiradentesDGWidget> {
  late Setor6321TiradentesDGModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Setor6321TiradentesDGModel());
                        ...
                        children: [
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        address:
                                            'R. Apóstolo Filipe, 103 - Cidade Tiradentes, São Paulo - SP, 08475-520',
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                16.0, 8.0, 0.0, 0.0),
                            child: Text(
                              'R. Apóstolo Filipe, 103 - Cidade Tiradentes',
                              style: FlutterFlowTheme.of(context)
                                  .headlineSmall
                                  .override(
                                    fontFamily: 'Plus Jakarta Sans',
