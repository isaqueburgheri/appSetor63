...
import 'setor6322_tiradentes_ferrovirios_model.dart';
export 'setor6322_tiradentes_ferrovirios_model.dart';

class Setor6322TiradentesFerroviriosWidget extends StatefulWidget {
  const Setor6322TiradentesFerroviriosWidget({super.key});

  @override
  State<Setor6322TiradentesFerroviriosWidget> createState() =>
      _Setor6322TiradentesFerroviriosWidgetState();
}

class _Setor6322TiradentesFerroviriosWidgetState
    extends State<Setor6322TiradentesFerroviriosWidget> {
  late Setor6322TiradentesFerroviriosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Setor6322TiradentesFerroviriosModel());
                        ...
                        children: [
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        address:
                                            'R. Edmundo Orioli, 180 - Cidade Tiradentes, São Paulo - SP, 08470-600',
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                16.0, 8.0, 0.0, 0.0),
                            child: Text(
                              'R. Edmundo Orioli, 180 - Cidade Tiradentes',
                              style: FlutterFlowTheme.of(context)
                                  .headlineSmall
                                  .override(
                                    fontFamily: 'Plus Jakarta Sans',
