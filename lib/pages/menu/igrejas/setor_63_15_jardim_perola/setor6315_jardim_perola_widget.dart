...
import 'setor6315_jardim_perola_model.dart';
export 'setor6315_jardim_perola_model.dart';

class Setor6315JardimPerolaWidget extends StatefulWidget {
  const Setor6315JardimPerolaWidget({super.key});

  @override
  State<Setor6315JardimPerolaWidget> createState() =>
      _Setor6315JardimPerolaWidgetState();
}

class _Setor6315JardimPerolaWidgetState
    extends State<Setor6315JardimPerolaWidget> {
  late Setor6315JardimPerolaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Setor6315JardimPerolaModel());
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        address:
                                            'R. Jaime Ovale, 39a - Conj. Hab. Sitio Conceicao, São Paulo - SP, 08474-390',
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
