...
class Setor6306CityConceicaoWidget extends StatefulWidget {
  const Setor6306CityConceicaoWidget({Key? key}) : super(key: key);

  @override
  _Setor6306CityConceicaoWidgetState createState() =>
      _Setor6306CityConceicaoWidgetState();
}

class _Setor6306CityConceicaoWidgetState
    extends State<Setor6306CityConceicaoWidget> {
  late Setor6306CityConceicaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Setor6306CityConceicaoModel());
  }
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: Image.asset(
                            'assets/images/278589706_497986631804859_2420035474736658665_n.jpg',
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
