...
import 'setor6302_barro_branco_model.dart';
export 'setor6302_barro_branco_model.dart';

class Setor6302BarroBrancoWidget extends StatefulWidget {
  const Setor6302BarroBrancoWidget({super.key});

  @override
  State<Setor6302BarroBrancoWidget> createState() =>
      _Setor6302BarroBrancoWidgetState();
}

class _Setor6302BarroBrancoWidgetState
    extends State<Setor6302BarroBrancoWidget> {
  late Setor6302BarroBrancoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Setor6302BarroBrancoModel());
                        ...
                        children: [
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        address:
                                            'Rua Cachoeira Três Ilhas, 20 - Conj. Hab. Castro Alves São Paulo - SP, 08475-130',
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        location: FFAppState().localBarroBranco,
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                16.0, 8.0, 0.0, 0.0),
                            child: Text(
                              'Rua Cachoeira Três Ilhas, 20 - Conj. Hab. Castro Alves',
                              style: FlutterFlowTheme.of(context)
                                  .headlineSmall
                                  .override(
                                    fontFamily: 'Plus Jakarta Sans',
