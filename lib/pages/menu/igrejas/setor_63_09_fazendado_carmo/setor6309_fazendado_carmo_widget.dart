...
import 'setor6309_fazendado_carmo_model.dart';
export 'setor6309_fazendado_carmo_model.dart';

class Setor6309FazendadoCarmoWidget extends StatefulWidget {
  const Setor6309FazendadoCarmoWidget({super.key});

  @override
  State<Setor6309FazendadoCarmoWidget> createState() =>
      _Setor6309FazendadoCarmoWidgetState();
}

class _Setor6309FazendadoCarmoWidgetState
    extends State<Setor6309FazendadoCarmoWidget> {
  late Setor6309FazendadoCarmoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Setor6309FazendadoCarmoModel());
                        ...
                        children: [
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      await launchMap(
                                        ...
                                        address:
                                            'R. Coração Sertanejo, 30 - Conj. Hab. Fazenda do Carmo, São Paulo - SP, 08421-550',
                                        title: '',
                                      );
                                    },
                                    child: ClipRRect(
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                16.0, 8.0, 0.0, 0.0),
                            child: Text(
                              'R. Coração Sertanejo, 30 - Conj. Hab. Fazenda do Carmo',
                              style: FlutterFlowTheme.of(context)
                                  .headlineSmall
                                  .override(
                                    fontFamily: 'Plus Jakarta Sans',
