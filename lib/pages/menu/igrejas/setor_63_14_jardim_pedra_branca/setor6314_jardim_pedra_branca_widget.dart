...
import 'setor6314_jardim_pedra_branca_model.dart';
export 'setor6314_jardim_pedra_branca_model.dart';

class Setor6314JardimPedraBrancaWidget extends StatefulWidget {
  const Setor6314JardimPedraBrancaWidget({super.key});

  @override
  State<Setor6314JardimPedraBrancaWidget> createState() =>
      _Setor6314JardimPedraBrancaWidgetState();
}

class _Setor6314JardimPedraBrancaWidgetState
    extends State<Setor6314JardimPedraBrancaWidget> {
  late Setor6314JardimPedraBrancaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Setor6314JardimPedraBrancaModel());
            ...
            children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Rua Olária-N°56 - Jd pedra Branca',
                          style: FlutterFlowTheme.of(context)
                              .headlineSmall
                              .override(
                                fontFamily: 'Plus Jakarta Sans',
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    await launchMap(
                      address: 'Rua Olária-N°56 / Jd pedra Branca',
                      title: '',
                    );
                  },
                  child: Container(
