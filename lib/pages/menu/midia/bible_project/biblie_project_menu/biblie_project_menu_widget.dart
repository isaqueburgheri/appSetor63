...
class BiblieProjectMenuWidget extends StatefulWidget {
  const BiblieProjectMenuWidget({super.key});

  @override
  State<BiblieProjectMenuWidget> createState() =>
                                                      ...
                                                      padding:
                                                          const EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: AutoSizeText(
                                                        'Clique aqui para entender o projeto.',
                                                        textAlign:
                                                            TextAlign.center,
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                        ...
                                                        Align(
                                                          alignment:
                                                              const AlignmentDirectional(
                                                                  0.0, 0.0),
                                                          child: AutoSizeText(
                                                            'O conteúdo  a seguir pertence ao BibleProject, uma organização independente que explora temas bíblicos de forma poética e narrativa, sem associação a uma denominação cristã específica. Eles buscam alcançar pessoas de diferentes convicções religiosas e não religiosas, não promovendo tradições cristãs específicas. Seu objetivo principal é permitir a exploração das histórias e ideias teológicas das Escrituras por si mesmas, e não há nenhuma ligação direta ou indireta com a Assembleia de Deus - Belém.',
                                                            textAlign: TextAlign
                                                                .center,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
