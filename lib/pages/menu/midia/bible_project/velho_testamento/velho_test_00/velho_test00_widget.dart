...
class VelhoTest00Widget extends StatefulWidget {
  const VelhoTest00Widget({super.key});

  @override
  State<VelhoTest00Widget> createState() => _VelhoTest00WidgetState();
}

class _VelhoTest00WidgetState extends State<VelhoTest00Widget> {
  late VelhoTest00Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VelhoTest00Model());
  }
