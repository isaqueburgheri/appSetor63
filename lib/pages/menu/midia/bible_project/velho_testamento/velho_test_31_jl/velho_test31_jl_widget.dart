...
class VelhoTest31JlWidget extends StatefulWidget {
  const VelhoTest31JlWidget({super.key});

  @override
  State<VelhoTest31JlWidget> createState() => _VelhoTest31JlWidgetState();
}

class _VelhoTest31JlWidgetState extends State<VelhoTest31JlWidget> {
  late VelhoTest31JlModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VelhoTest31JlModel());
  }
        ...
        child: Column(
          ...
          children: [
            const FlutterFlowYoutubePlayer(
              url: 'https://youtu.be/uQoMheoe904?si=aEdQb6ky09pUUrHN',
              autoPlay: false,
              looping: false,
              mute: false,
              showControls: true,
